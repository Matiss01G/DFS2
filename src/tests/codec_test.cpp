...
struct LoggingInitializer {
    LoggingInitializer() {
        ...
        if (!initialized) {
            ...
            // Add console output with custom formatter
...
protected:
    ...
    Codec* codec_;
    Channel* channel_;
    static LoggingInitializer logging_init_;
...
// Initialize the static logging initializer
LoggingInitializer CodecTest::logging_init_;
