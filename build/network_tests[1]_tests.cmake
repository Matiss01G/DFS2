...
add_test([=[CodecTest.BasicSerialization]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.BasicSerialization]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.BasicSerialization]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.SerializationEncryption]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.SerializationEncryption]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.SerializationEncryption]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.LargeMessageSerialization]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.LargeMessageSerialization]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.LargeMessageSerialization]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.BasicDeserialization]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.BasicDeserialization]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.BasicDeserialization]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.EncryptedDataDeserialization]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.EncryptedDataDeserialization]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.EncryptedDataDeserialization]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.LargeMessageDeserialization]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.LargeMessageDeserialization]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.LargeMessageDeserialization]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
...
add_test([=[CodecTest.SerializationErrorHandling]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.SerializationErrorHandling]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.SerializationErrorHandling]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.DeserializationErrorHandling]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.DeserializationErrorHandling]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.DeserializationErrorHandling]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.InvalidKeySize]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.InvalidKeySize]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.InvalidKeySize]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
set(  network_tests_TESTS TCPPeerTest.ConnectionTest TCPPeerTest.DisconnectionTest TCPPeerTest.SendStreamTest TCPPeerTest.ReceiveStreamTest TCPPeerTest.MultipleMessagesTest TCPPeerTest.EdgeCasesTest PeerManagerTest.InitializationTest PeerManagerTest.AddValidPeerTest PeerManagerTest.AddNullPeerTest PeerManagerTest.AddDuplicatePeerTest PeerManagerTest.RemoveExistingPeerTest PeerManagerTest.RemoveNonExistentPeerTest PeerManagerTest.GetNonExistentPeerTest PeerManagerTest.ThreadSafetyTest PeerManagerTest.ShutdownTest PeerManagerTest.BroadcastStreamTest PeerManagerTest.BroadcastMixedResultsTest CodecTest.BasicSerialization CodecTest.SerializationEncryption CodecTest.LargeMessageSerialization CodecTest.BasicDeserialization CodecTest.EncryptedDataDeserialization CodecTest.LargeMessageDeserialization CodecTest.ChannelIntegration CodecTest.SerializationErrorHandling CodecTest.DeserializationErrorHandling CodecTest.InvalidKeySize)
