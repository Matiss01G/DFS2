...
add_test([=[CodecTest.BasicSerializationTest]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.BasicSerializationTest]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.BasicSerializationTest]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.LargeDataSerializationTest]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.LargeDataSerializationTest]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.LargeDataSerializationTest]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.ChannelIntegrationTest]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.ChannelIntegrationTest]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.ChannelIntegrationTest]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
set(  network_tests_TESTS TCPPeerTest.ConnectionTest TCPPeerTest.DisconnectionTest TCPPeerTest.SendStreamTest TCPPeerTest.ReceiveStreamTest TCPPeerTest.MultipleMessagesTest TCPPeerTest.EdgeCasesTest PeerManagerTest.InitializationTest PeerManagerTest.AddValidPeerTest PeerManagerTest.AddNullPeerTest PeerManagerTest.AddDuplicatePeerTest PeerManagerTest.RemoveExistingPeerTest PeerManagerTest.RemoveNonExistentPeerTest PeerManagerTest.GetNonExistentPeerTest PeerManagerTest.ThreadSafetyTest PeerManagerTest.ShutdownTest PeerManagerTest.BroadcastStreamTest PeerManagerTest.BroadcastMixedResultsTest CodecTest.BasicSerializationTest CodecTest.LargeDataSerializationTest CodecTest.ChannelIntegrationTest)
