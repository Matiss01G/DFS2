...
add_test([=[CodecTest.MinimalFrameSerializeDeserialize]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.MinimalFrameSerializeDeserialize]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.MinimalFrameSerializeDeserialize]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.BasicSerializeDeserialize]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.BasicSerializeDeserialize]==] --gtest_also_run_disabled_tests)
...
add_test([=[CodecTest.LargePayloadChunkedProcessing]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.LargePayloadChunkedProcessing]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.LargePayloadChunkedProcessing]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.MalformedInputHandling]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.MalformedInputHandling]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.MalformedInputHandling]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.ZeroLengthPayload]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.ZeroLengthPayload]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.ZeroLengthPayload]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
