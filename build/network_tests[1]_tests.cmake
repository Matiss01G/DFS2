...
add_test([=[CodecTest.SerializeBasicFrame]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.SerializeBasicFrame]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.SerializeBasicFrame]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.SerializeWithPayload]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.SerializeWithPayload]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.SerializeWithPayload]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.DeserializeBasicFrame]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.DeserializeBasicFrame]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.DeserializeBasicFrame]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test([=[CodecTest.ChannelIntegrationWithPayload]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.ChannelIntegrationWithPayload]==] --gtest_also_run_disabled_tests)
...
add_test([=[CodecTest.ErrorCases]=]  /home/runner/StreamCryptoDFS/build/network_tests [==[--gtest_filter=CodecTest.ErrorCases]==] --gtest_also_run_disabled_tests)
set_tests_properties([=[CodecTest.ErrorCases]=]  PROPERTIES WORKING_DIRECTORY /home/runner/StreamCryptoDFS/build SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
set(  network_tests_TESTS TCPPeerTest.ConnectionTest TCPPeerTest.DisconnectionTest TCPPeerTest.SendStreamTest TCPPeerTest.ReceiveStreamTest TCPPeerTest.MultipleMessagesTest TCPPeerTest.EdgeCasesTest PeerManagerTest.InitializationTest PeerManagerTest.AddValidPeerTest PeerManagerTest.AddNullPeerTest PeerManagerTest.AddDuplicatePeerTest PeerManagerTest.RemoveExistingPeerTest PeerManagerTest.RemoveNonExistentPeerTest PeerManagerTest.GetNonExistentPeerTest PeerManagerTest.ThreadSafetyTest PeerManagerTest.ShutdownTest CodecTest.SerializeBasicFrame CodecTest.SerializeWithPayload CodecTest.DeserializeBasicFrame CodecTest.ChannelIntegrationWithPayload CodecTest.ErrorCases)
