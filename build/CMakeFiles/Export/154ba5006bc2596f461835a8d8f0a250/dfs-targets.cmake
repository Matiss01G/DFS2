...
# Create imported target dfs::dfs_crypto
add_library(dfs::dfs_crypto STATIC IMPORTED)
...
set_target_properties(dfs::dfs_network PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "dfs::dfs_crypto;Boost::system;Boost::thread"
)

# Load information for each installed configuration.
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/dfs-targets-*.cmake")
